...
public class QRCodeHandler extends Handler {
    ...
    public QRCodeHandler(QRCodeViewManager viewManager, CameraManager cameraManager, int decodeMode) {
        this.viewManager = viewManager;
        decodeThread = new DecodeThread(viewManager, decodeMode);
        decodeThread.start();
        state = State.SUCCESS;
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.restart_preview) {
            ...
            viewManager.handleDecode((Result) message.obj, bundle);
